...
class LLMEvasionStrategyEngine:
    ...
    def generate_strategy(self, baseline: dict | None = None, last_feedback: NetworkFeedback | None = None) -> MutationStrategy:
        ...
        current_human_message = HumanMessage(content=(
            ...
            "Based on the BASELINE TRAFFIC PROFILE and the LAST DROP FEEDBACK, decide which field to mutate among 'ttl', 'win_size', 'seq_num', 'user_agent', 'accept_language'. "
        ...
        messages = [
            SystemMessage(content=(
                ...
                "You must DIVERSIFY your attacks."
                "You must alternate between Network layer and Application layer evasions.\n\n"
                ...
                "- 'accept_language' (String, HTTP Accept-Language header)\n"
                "Constraints:\n"
                "1. Output ONLY a valid JSON object. No markdown, no intro, no outro.\n"
                "2. Use this exact schema:\n"
                "{\n"
                '  "field_to_mutate": "<must be exactly one of: ttl, win_size, seq_num, user_agent, accept_language>",\n'
                '  "new_value": <integer for ttl/win_size/seq_num, String for user_agent, accept_language>,\n'
